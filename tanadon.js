...
const beverages = [
  ...
  function renderSnacks() {
    ...
    for (let snack of snacks) {
      ...
      const snackHTML = `
        ...
        <div class="product-category" id="snack-container"></div>
        <img src="snack[id].png"></img>
          <h3>${snack.name}</h3>
  ...
  function renderBeverages(){
    ...
    for(let beverage of beverages){
        ...
        const beverageHTML = `
        <div class="product-card">
        <div class="product-category" id="beverage-container"></div>
        <img src="beverage[id].png"></img>
          <h3>${beverage.name}</h3>
